...
function MyPage({ isAuthenticated }) {
  ...
  // 테스트용 시작
const testHandler = localStorage.getItem("userId")
console.log(testHandler);
  ...
  useEffect(() => {
    ...
    const updateUserData = async () => {
      try {
        const response = await axios.put(`${BASE_URL}/me`, formData, {
          headers: {
        ...
        <div className="mypage-container">
          ...
          <div className="mypage-content">
            <div className="tabs">
              ...
              <div
                className={`tab-content ${activeTab === "dog" ? "active" : ""}`}
              >
                <div className="card">
                  <div className="card-header">
